...
const getPokemon = async (id: string): Promise<Pokemon> => {
  ...
  if (!resp.ok) {
    // Pokemon no existe → Lanza la página 404
    notFound();
  }
...
export default async function PokemonPage(props: { params: any }) {
  // Si props.params es una Promise, lo resolvemos; si no, lo usamos tal cual
  const params = await Promise.resolve(props.params);
